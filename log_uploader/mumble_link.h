...
public:
	...
	bool initialize(std::string linked_mem_name = "MumbleLink");
...
private:
	...
	std::string linked_mem_name = "MumbleLink";
	LinkedMem* linked_mem = nullptr;
	HANDLE file_handle = nullptr;
};

namespace global { extern std::unique_ptr<MumbleLink> mumble_link; }
